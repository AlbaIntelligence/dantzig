defmodule Dantzig.Core.ProblemASTTest do
  @moduledoc """
  Tests for Problem AST transformation functionality.

  This module tests AST transformations for constraint expressions, objective expressions,
  and description interpolation.
  """
  use ExUnit.Case
