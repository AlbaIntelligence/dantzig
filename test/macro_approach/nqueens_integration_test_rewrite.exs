defmodule MacroApproach.NQueensIntegrationTest do
  ...
  # Test complete N-Queens example with imperative Problem.add_constraints syntax
  test "Complete N-Queens problem with Problem.add_constraints syntax" do
    # Create the N-Queens problem using imperative syntax
    problem =
      Dantzig.Problem.new(
        name: "N-Queens",
        description:
    ...
    # Add constraints: one queen per row
    problem =
      Dantzig.Problem.add_constraints(
        problem,
        [quote(do: i <- 1..4)],
    ...
    # Set objective (maximize total queens)
    problem =
      Dantzig.Problem.set_objective(
        problem,
        quote(do: queen2d(:_, :_)),
        direction: :maximize
      )
  ...
  # Test N-Queens problem with single constraints using Problem.add_one_constraint
  test "N-Queens problem with single constraints" do
    ...
    # Add individual constraints using add_one_constraint
    # Note: This would require implementing add_one_constraint for single constraints
    # For now, we'll use add_constraints with single-element generators
  ...
  # Test N-Queens problem with sum expressions using imperative syntax
  test "N-Queens problem with sum expressions using imperative syntax" do
    # Test N-Queens with sum expressions using imperative syntax
