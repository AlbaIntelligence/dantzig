...
The DSL syntax reference (`docs/DSL_SYNTAX_REFERENCE.md`) has been extended with section 6: "Access to Constants and to Enumerated Constants". This extension introduces support for:
...
**Recommendation**: Update all examples in `model-parameters-api.md` to use direct access syntax, matching DSL_SYNTAX_REFERENCE.md.
...
**DSL_SYNTAX_REFERENCE.md**: ✅ Complete (section 6 added)
...
2. Add examples demonstrating map/list access patterns from DSL_SYNTAX_REFERENCE.md
...
- [ ] T175 [DOC] Verify `DSL_SYNTAX_REFERENCE.md` examples align with implementation
```
...
- Align all examples with DSL_SYNTAX_REFERENCE.md

### Step 2: Add Tests (TDD Approach)
- Write failing tests for constant access patterns
- Ensure tests cover all syntax patterns from DSL_SYNTAX_REFERENCE.md
...
- [ ] All examples in DSL_SYNTAX_REFERENCE.md section 6 execute successfully
